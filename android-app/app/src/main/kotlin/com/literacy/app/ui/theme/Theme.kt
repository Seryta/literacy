...
private val LiteracyColorScheme = when (ACTIVE_SCHEME) {
    "fresh" -> lightColorScheme(
        ...
        // 现代分层（iOS/Fluent）：surfaceContainer 系列从背景逐级抬升
        surfaceContainerLowest = SchemeFresh.background,
        surfaceContainerLow = Color(0xFFEAF2EE),
        surfaceContainer = Color(0xFFE4EDE8),
        surfaceContainerHigh = Color(0xFFDEE8E2),
        surfaceContainerHighest = Color(0xFFD8E2DC),
    ...
    "vivid" -> lightColorScheme(
        ...
        surfaceContainerLowest = SchemeVivid.background,
        surfaceContainerLow = Color(0xFFF8EAE0),
        surfaceContainer = Color(0xFFF3E4D8),
        surfaceContainerHigh = Color(0xFFEDDED2),
        surfaceContainerHighest = Color(0xFFE7D8CC),
        error = Color(0xFFBA1A1A),
        onError = Color(0xFFFFFFFF),
        errorContainer = Color(0xFFFFDAD6),
        onErrorContainer = Color(0xFF410002),
        ...
        surfaceContainerLowest = SchemeWarm.background,
        surfaceContainerLow = Color(0xFFF7EFE3),
        surfaceContainer = Color(0xFFF1E8DA),
        surfaceContainerHigh = Color(0xFFEBE2D3),
        surfaceContainerHighest = Color(0xFFE5DCCC),
        error = Color(0xFFBA1A1A),
        onError = Color(0xFFFFFFFF),
        errorContainer = Color(0xFFFFDAD6),
        onErrorContainer = Color(0xFF410002),
