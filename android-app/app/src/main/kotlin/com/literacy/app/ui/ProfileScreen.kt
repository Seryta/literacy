...
fun ProfileScreen(
    ...
    Column(
        ...
        Text("建档", style = MaterialTheme.typography.headlineMedium)
        ...
        savedSummary?.let { summary ->
            ...
            Button(onClick = onComplete, modifier = Modifier.fillMaxWidth()) { Text("返回首页，开始学习我的名字 →") }
        }

        Spacer(Modifier.height(16.dp))
        TextButton(onClick = onComplete) { Text("← 返回") }
    }
}
